...
print("             ------Entire programme with FILE------\n")
...
def preview_choice():
    ...
    print("| 3 - Write the input data in a atext file and read them |")
...
def read_write_to_file():
    '''store data into a file and read from the file'''
    
    with open("progressReport.txt","w") as file:
        for i in progress_list:
            file.write("Progress - " + str(i) + "\n")
        for i in trailer_list:
            file.write("Trailer - " + str(i) + "\n")
        for i in retriever_list:
            file.write("Retriever - " + str(i) + "\n")
        for i in excluded_list:
            file.write("Excluded - " + str(i) + "\n")

    with open("progressReport.txt", "r") as file:
        print()
        print("Data from saved text file")
        print(file.read())
